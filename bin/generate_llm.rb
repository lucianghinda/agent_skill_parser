...
main_path = File.join(doc_dir, "AgentSkillParser.md")
...
doc_with_updated_links = llm_doc.gsub(%r{\[AgentSkillParser/}, "[doc/AgentSkillParser/")
doc_with_updated_links = doc_with_updated_links.gsub(%r{\(AgentSkillParser/}, "(doc/AgentSkillParser/")
